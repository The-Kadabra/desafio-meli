resource "helm_release" "argocd" {
  ...
  set {
    ...
    value = "argocd.coreplatform.com.br"
  }
...
resource "helm_release" "ingress_nginx" {
  ...
  set {
    ...
    value = aws_acm_certificate.core_wildcard.arn
  }
        ...
        Condition = {
          ...
          StringLike = {
            "token.actions.githubusercontent.com:sub" = [
              "repo:The-Kadabra/desafio-meli:ref:refs/heads/*",
              "repo:The-Kadabra/desafio-meli:ref:refs/tags/*",
              "repo:The-Kadabra/desafio-meli:ref:refs/pull/*/merge"
            ]
          }
        }
      }
...
resource "aws_acm_certificate" "core_wildcard" {
  domain_name       = "*.coreplatform.com.br"
...
module "iam_eks_role" {
  ...
  oidc_providers = {
    one = {
      ...
      namespace_service_accounts = ["*:hook-core-db"]
    }
  }
